...
# wagon_count/ holds the Stage-1 modules (flat, as in wagon_count_global).
...
class TestCameraIndependence(unittest.TestCase):
    ...
    def test_no_train_specific_constants_in_the_module(self):
        ...
        """
        # wagon_count/ holds the Stage-1 modules in this repo (flat in the
        # wagon_count_global reference this test came from).
        path = os.path.join(os.path.dirname(os.path.dirname(
            os.path.abspath(__file__))), "wagon_count", "fragment_stitching.py")
